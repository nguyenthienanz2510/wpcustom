...
<form class="woocommerce-ordering" method="get">
	<div class="woocommerce-ordering-label">
		<?php esc_html_e( 'Sort by:', 'copenhagen' ); ?>
	</div>
	<select name="orderby" class="orderby" aria-label="<?php esc_attr_e( 'Shop order', 'copenhagen' ); ?>">
