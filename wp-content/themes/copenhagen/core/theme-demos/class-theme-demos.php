...
if ( ! class_exists( 'MBF_Theme_Demos' ) ) {
	...
	class MBF_Theme_Demos {
		...
		public function add_menu_page() {
			add_submenu_page( 'themes.php', esc_html__( 'Theme Demos', 'copenhagen' ), esc_html__( 'Theme Demos', 'copenhagen' ), 'manage_options', $this->menu_slug, array( $this, 'html_carcase' ), 2 );
		}
		...
		public function html_import_data() {
			...
			if ( $demo_id ) {
				...
				if ( ! isset( $this->demos[ $demo_id ] ) ) {
					wp_send_json_error( esc_html__( 'Invalid demo content id.', 'copenhagen' ) );
					wp_die();
				}
				...
				<div class="mbf-import-data">
					<?php if ( $demo_plugins ) { ?>
						<div class="mbf-import-plugins">
							<div class="mbf-import-subheader">
								<?php esc_html_e( 'Install Plugins', 'copenhagen' ); ?>
							</div>
							...
							foreach ( $demo_plugins as $plugin ) {
								...
								<form>
									<div class="mbf-switcher">
										...
										<div class="mbf-tooltip"><?php esc_html_e( 'Required plugin will be installed', 'copenhagen' ); ?></div>
									</div>
									...
									<input type="hidden" name="step_name" value="<?php esc_attr_e( 'Installing and activating', 'copenhagen' ); ?> <?php echo esc_attr( $plugin['name'] ); ?>...">
					...
					<div class="mbf-import-content">
						<div class="mbf-import-subheader">
							<?php esc_html_e( 'Import Content', 'copenhagen' ); ?>
						</div>
								...
								<?php foreach ( $kits as $kit ) { ?>
									<form>
										<div class="mbf-switcher">
											...
											<input type="hidden" name="step_name" value="<?php esc_attr_e( 'Importing', 'copenhagen' ); ?> <?php echo esc_attr( $kit['label'] ); ?> ...">
						...
						<?php if ( isset( $demo_data['import']['customizer'] ) && $demo_data['import']['customizer'] ) { ?>
							<form>
								<div class="mbf-switcher">
									<?php esc_html_e( 'Customizer', 'copenhagen' ); ?> <input class="mbf-checkbox" type="checkbox" name="url" value="<?php echo esc_attr( $demo_data['import']['customizer'] ); ?>" checked>

									<div class="mbf-switch"><span class="mbf-switch-slider"></span></div>
								</div>

								<input type="hidden" name="step_name" value="<?php esc_attr_e( 'Importing customizer options...', 'copenhagen' ); ?>">
						...
						<?php if ( isset( $demo_data['import']['options'] ) && $demo_data['import']['options'] ) { ?>
							<form>
								<div class="mbf-switcher">
									<?php esc_html_e( 'Options', 'copenhagen' ); ?> <input class="mbf-checkbox" type="checkbox" name="url" value="<?php echo esc_attr( $demo_data['import']['options'] ); ?>" checked>

									<div class="mbf-switch"><span class="mbf-switch-slider"></span></div>
								</div>

								<input type="hidden" name="step_name" value="<?php esc_attr_e( 'Importing options...', 'copenhagen' ); ?>">
						...
						<?php if ( isset( $demo_data['import']['widgets'] ) && $demo_data['import']['widgets'] ) { ?>
							<form>
								<div class="mbf-switcher">
									<?php esc_html_e( 'Widgets', 'copenhagen' ); ?> <input class="mbf-checkbox" type="checkbox" name="url" value="<?php echo esc_attr( $demo_data['import']['widgets'] ); ?>" checked>

									<div class="mbf-switch"><span class="mbf-switch-slider"></span></div>
								</div>

								<input type="hidden" name="step_name" value="<?php esc_attr_e( 'Importing widgets...', 'copenhagen' ); ?>">
						...
						<form class="hidden">
							<div class="mbf-switcher">
								<?php esc_html_e( 'Finish', 'copenhagen' ); ?> <input class="mbf-checkbox" type="checkbox" name="finish" value="1" checked>

								<div class="mbf-switch"><span class="mbf-switch-slider"></span></div>
							</div>

							<input type="hidden" name="step_name" value="<?php esc_attr_e( 'Finishing setup...', 'copenhagen' ); ?>">
				...
				wp_send_json_error( esc_html__( 'Demo content id not set.', 'copenhagen' ) );
			}
		...
		public function html_carcase() {
			...
			<div class="mbf-wrap mbf-demos-page">
				<div class="mbf-header">
					<div class="mbf-header-left">
						<div class="mbf-header-col mbf-header-col-logo">
							<div class="mbf-logo">
								<a target="_blank" href="<?php echo esc_url( 'https://merchantsbestfriends.com/' ); ?>">
									Merchants’ Best Friends
								</a>
							</div>
						</div>
					</div>
				...
				<div class="wrap">
					<h1 class="hidden"><?php esc_html_e( 'Theme Demos', 'copenhagen' ); ?></h1>
										...
										<div class="mbf-demo-thumbnail">
											...
											<?php if ( isset( $demo['preview'] ) && $demo['preview'] ) { ?>
												<div class="mbf-demo-preview">
													<span>
														<?php esc_html_e( 'Preview Demo', 'copenhagen' ); ?>
													</span>
												</div>
											<?php } ?>
										</div>
						...
						<div class="mbf-import-container">
							<div class="mbf-import-step mbf-import-step-active mbf-import-start">
								<div class="mbf-import-header">
									<?php esc_html_e( 'Import Theme', 'copenhagen' ); ?>
								</div>
							...
							<div class="mbf-import-step mbf-import-process">
								<div class="mbf-import-header">
									<?php esc_html_e( 'Installing', 'copenhagen' ); ?>
								</div>

								<div class="mbf-import-output">
									<div class="mbf-import-desc">
										<?php esc_html_e( 'Please be patient and don\'t refresh this page, the import process may take a while, this also depends on your server.', 'copenhagen' ); ?>
									</div>
							...
							<div class="mbf-import-step mbf-import-finish">
								<div class="mbf-import-info">
									...
									<div class="mbf-import-title">
										<?php esc_html_e( 'Imported Succefully', 'copenhagen' ); ?>
									</div>

									<div class="mbf-import-desc">
										<?php esc_html_e( 'Go ahead, customize the text, images and design to make it yours!', 'copenhagen' ); ?>
									</div>

									<div class="mbf-import-customize">
										<a href="<?php echo esc_url( admin_url( '/customize.php' ) ); ?>" class="button button-primary" target="_blank">
											<?php esc_html_e( 'Customize', 'copenhagen' ); ?>
										</a>
									</div>
								</div>
								...
								<div class="mbf-import-actions">
									<a href="<?php echo esc_url( home_url() ); ?>" class="mbf-button button" target="_blank">
										<?php esc_html_e( 'View Site', 'copenhagen' ); ?>
									</a>
								</div>
							</div>
						</div>
		...
		public function admin_enqueue_scripts( $page ) {
			...
			wp_localize_script( 'mbf-theme-demos', 'cscoThemeDemosConfig', array(
				'ajax_url'       => admin_url( 'admin-ajax.php' ),
				'nonce'          => wp_create_nonce( 'nonce' ),
				'failed_message' => esc_html__( 'Something went wrong, contact support.', 'copenhagen' ),
			) );
			...
			// Add RTL support.
			wp_style_add_data( 'copenhagen', 'rtl', 'replace' );
		}
	}
