 ...
 * Text Domain:       mobcec-standard-banner
...
function activate_mobcec_standard_banner()
{
    Inc\Base\Activate::activate();
}
register_activation_hook(__FILE__, 'activate_mobcec_standard_banner');

function deactivate_mobcec_standard_banner()
{
    Inc\Base\Deactivate::deactivate();
}
register_deactivation_hook(__FILE__, 'deactivate_mobcec_standard_banner');
