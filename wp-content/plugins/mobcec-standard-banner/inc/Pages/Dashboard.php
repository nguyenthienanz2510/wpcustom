...
class Dashboard extends BaseController
{
    ...
    protected function setPages()
    {
        $this->pages = [
            [
                ...
                'menu_slug'     => 'mobcec_standard_banner',
    ...
    public function setSettings()
    {
        $args = array(
            array(
                'option_group' => 'mobcec_standard_banner_settings',
                'option_name' => 'mobcec_standard_banner',
    ...
    public function setFields()
    {
        ...
        foreach ($this->managers as $key => $value) {
            $args[] = array(
                ...
                'page' => 'mobcec_standard_banner',
                'section' => 'mobcec_standard_banner_admin_index',
                'args' => array(
                    'option_name' => 'mobcec_standard_banner',
                    'label_for' => $key,
                    'class'   => 'anz-toggle',
